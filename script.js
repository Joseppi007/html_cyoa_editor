...
function open_custom_theme_page_options_menu() {
	...
	story_data.custom_theme = Array(20).fill().map(()=>random_color());
    }
    for (let i = 0; i < 20; i++) {
